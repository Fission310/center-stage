...
public class Controls {
    ...
    public static final Input CLIMB = Input.DPAD_LEFT;
    public static final Input SCORE = Input.LEFT_BUMPER;
    public static final Input SCORE_LEFT = Input.LEFT_BUMPER;
    public static final Input SCORE_RIGHT = Input.RIGHT_BUMPER;
    public static final Input GRAB = Input.RIGHT_TRIGGER;
    ...
    public static final Input INTAKE_LEFT = Input.DPAD_UP;
    public static final Input INTAKE_RIGHT = Input.DPAD_DOWN;
