...
public class Controls {
    ...
    public static final Input SCORE_LEFT = Input.DPAD_UP;
    public static final Input SCORE_RIGHT = Input.DPAD_DOWN;
    ...
    public static final Input WRIST_LEFT = Input.LEFT_BUMPER;
    public static final Input WRIST_RIGHT = Input.RIGHT_BUMPER;
}
