...
public class TrussConstantsBlue extends TrussConstants {
    ...
    public static double SPIKE_LEFT_OFFSET_Y_B = -2;
    ...
    public static double STACK_Y_OFFSET_2_B = 3;
    public static double STACK_X_OFFSET_1_L_B = 4;
    public static double STACK_X_OFFSET_2_L_B = 4;
    public static double STACK_X_OFFSET_1_C_B = 3;
    public static double STACK_X_OFFSET_2_C_B = 3;
    public static double STACK_X_OFFSET_1_R_B = 0.5;
    public static double STACK_X_OFFSET_2_R_B = 0.5;

    public static double TAG_X_OFFSET_1_L_B = 5;
    public static double TAG_X_OFFSET_2_L_B = 5;
    public static double TAG_X_OFFSET_1_C_B = 6;
    public static double TAG_X_OFFSET_2_C_B = 6;
    public static double TAG_X_OFFSET_1_R_B = 6;
    public static double TAG_X_OFFSET_2_R_B = 6;

    public static double TAG_LEFT_OFFSET_B = -2.5;
    public static double TAG_CENTER_OFFSET_B = -0.9;
