...
public class TrussConstantsBlue extends TrussConstants {
    public static double SPIKE_LEFT_OFFSET_X_B = -23;
    ...
    public static double STACK_X_OFFSET_1_L_B = 3.2;
    ...
    public static double TRUSS_Y_OFFSET_B = -4;
    ...
    public static double TAG_LEFT_OFFSET_B = -3.5;
    public static double TAG_CENTER_OFFSET_B = 0.2;
    public static double TAG_RIGHT_OFFSET_B = 6;
