...
public class TrussConstantsBlue extends TrussConstants {
    public static double SPIKE_LEFT_OFFSET_X_B = -21;
    public static double SPIKE_LEFT_OFFSET_Y_B = -4;
    public static double SPIKE_CENTER_OFFSET_X_B = -5;
    public static double SPIKE_CENTER_OFFSET_Y_B = -5;
    public static double SPIKE_RIGHT_OFFSET_X_B = 1.5;
    public static double SPIKE_RIGHT_OFFSET_Y_B = -3;

    public static double STACK_Y_OFFSET_1_B = 3;
    public static double STACK_Y_OFFSET_2_B = 5;
    public static double STACK_X_OFFSET_1_L_B = 6;
    public static double STACK_X_OFFSET_2_L_B = 9;
    public static double STACK_X_OFFSET_1_C_B = 2.2;
    public static double STACK_X_OFFSET_2_C_B = 8;
    public static double STACK_X_OFFSET_1_R_B = 0.8;
    public static double STACK_X_OFFSET_2_R_B = 6;

    public static double TRUSS_Y_OFFSET_B = -1;

    public static double TAG_X_OFFSET_1_L_B = 3;
    public static double TAG_X_OFFSET_2_L_B = 5;
    public static double TAG_X_OFFSET_1_C_B = 3;
    public static double TAG_X_OFFSET_2_C_B = 6;
    public static double TAG_X_OFFSET_1_R_B = 1;
    public static double TAG_X_OFFSET_2_R_B = 6;

    public static double TAG_LEFT_OFFSET_B = -3;
    public static double TAG_CENTER_OFFSET_B = 1.1;
    public static double TAG_RIGHT_OFFSET_B = 6.5;
    ...
    public static void set() {
        ...
        TRUSS_Y_OFFSET = TRUSS_Y_OFFSET_B;
