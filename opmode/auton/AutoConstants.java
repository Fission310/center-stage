...
public class AutoConstants {
    ...
    public static double TAG_RIGHT_Y = WALL_POS - 7.0 * TILE_LENGTH / 5.0 + 2;
    ...
    public static double FR_STACK_SECOND_X = -WALL_POS + 3.0 * BOT_LENGTH / 5.0 + 8;
    ...
    public static double WALL_START_X = FR_START_X + 10;
    public static double WALL_END_X = TRUSS_X - 28;
    public static double WALL_START_Y = TILE_LENGTH * 2.5 - 1;
    public static double WALL_END_Y = TILE_LENGTH * 2.5 - 1; //TILE_LENGTH * 2.5 + 5;
    ...
    public static void init() {
        ...
        WALL_START_VECTOR = new Vector2d(WALL_START_X, WALL_START_Y);
        WALL_END_VECTOR = new Vector2d(WALL_END_X,WALL_END_Y);
    }
}
