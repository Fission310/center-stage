...
public class AutoConstants {
    ...
    // Spike Mark
    public static double FR_SPIKE_TANGENT = UP;
    ...
    public static double FR_SPIKE_CENTER_Y = WALL_POS - 3.0 * TILE_LENGTH / 2.0;
    ...
    public static double FR_STACK_Y = WALL_POS - 5.0 * TILE_LENGTH / 2.0;
